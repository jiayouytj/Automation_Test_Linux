...
##################################################################################################################
#title           :es_install_ha_master_only_node.sh                                                              #
...
#                 The installation is on the master only node for Elasticsearch cluster,                         #
#                 which means that install.sh is correctly invoked and executed.                                 #
#author		     :Derek Li                                                                                       #
#date            :20190613                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./es_install_ha_master_only_node.sh                                                            #
#actual results  :Testcase es_install_ha_master_only_node.sh passed!                                             #
#expected results:Testcase es_install_ha_master_only_node.sh passed!                                             #
##################################################################################################################
