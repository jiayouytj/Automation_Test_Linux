...
##################################################################################################################
#title           :sanity_testrun_docker.sh                                                                       #
#description     :This script will copy all testcases, frameworks, installation packages, certificates, and ,    #
#                 dependencies then kick of sanity testruns of NetBrain Linux Component under CentOS 7.6 docker. #
#author		     :Zihao Yan                                                                                       #
#date            :20190606                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./sanity_testrun_docker.sh                                                                     #
...
#                             then run sanity testcases located within the testcase directory. The summary       #
...
cd $AA_testcase_dir;ls aa_install_clean.sh aa_install_special_path.sh \
aa_install_sudo2.sh aa_reinstall1.sh >../aa.list                                                                 #generate sanity Ansible Agent testlist
cd $DB_testcase_dir;ls db_install_clean.sh db_install_sudo1.sh \
db_install_special_path.sh db_reinstall1.sh >../db.list                                                          #generate sanity MongoDB testlist
cd $ES_testcase_dir;ls es_install_clean.sh es_install_sudo1.sh \
es_reinstall1.sh es_install_special_path.sh >../es.list                                                          #generate sanity Elasticsearch testlist
cd $LA_testcase_dir;ls la_install_clean.sh la_install_special_path.sh \
la_reinstall1.sh la_install_sudo2.sh >../la.list                                                                 #generate sanity License Agent testlist
cd $RE_testcase_dir;ls re_install_clean.sh re_install_sudo1.sh \
re_reinstall1.sh re_install_special_path.sh >../re.list                                                          #generate sanity Redis testlist
cd $MQ_testcase_dir;ls mq_install_bad_username2.sh mq_install_bad_password4.sh \
mq_install_bad_logpath2.sh mq_install_ssl_bad_key5.sh >../mq.list                                                #generate sanity RabbitMQ testlist
cd $SM_testcase_dir;ls sm_install_clean.sh sm_install_special_path.sh \
sm_install_sudo2.sh sm_reinstall1.sh >../sm.list                                                                 #generate sanity Service Monitor Agent testlist
cd $FS_testcase_dir;ls fs_install_sudo1.sh fs_install_sudo2.sh \
fs_reinstall1.sh fs_install_special_path.sh >../fs.list                                                          #generate sanity Front Server testlist
...
threshold=10                                                                                                     #the maximum number of concurrency
