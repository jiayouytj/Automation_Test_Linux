...
#################################################################################################################
#title           :CentOS7.6_docker_single.sh                                                                    #
#description     :This script will kick of a single testrun of NetBrain Linux Component under CentOS 7.6 docker #
#author		     :Zihao Yan                                                                                      #
#date            :20190605                                                                                      #
#version         :1.0                                                                                           #
#usage		     :./CentOS7.6_docker_single.sh [es|la|db|sm|mq|re|te|fs|aa|all]_*.sh                            #
...
#################################################################################################################
# Usage: CentOS7.6_docker_single.sh [es|la|db|sm|mq|re|fs|aa]_*.sh. the first parameter must be a .sh           #
# file with the name beginning with either es, la, db, sm, mq, re, te, fs, aa, and all lowercase                #
# Usage example: 1: ./CentOS7.6_docker_single.sh db_install.sh                                                  #
#                2: ./CentOS7.6_docker_single.sh es_install.sh                                                  #
#                3: ./CentOS7.6_docker_single.sh la_install.sh                                                  #
#                4: ./CentOS7.6_docker_single.sh sm_install.sh                                                  #
#                5: ./CentOS7.6_docker_single.sh mq_install.sh                                                  #
#                6: ./CentOS7.6_docker_single.sh re_install.sh                                                  #
#                7: ./CentOS7.6_docker_single.sh fs_install.sh                                                  #
#                8: ./CentOS7.6_docker_single.sh aa_install.sh                                                  #
#################################################################################################################	
 ...
 *)
  ...
  with [db|es|la|sm|mq|re|fs|aa] lowercase. The testrun aborted."
  exit 1 
esac 
