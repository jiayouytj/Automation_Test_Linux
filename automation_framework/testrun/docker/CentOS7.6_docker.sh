...
##################################################################################################################
#title           :CentOS7.6_docker.sh                                                                            #
#description     :This script will kick of testruns of all NetBrain Linux Component under CentOS 7.6 docker      #
#author		     :Zihao Yan                                                                                       #
#date            :20190211                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./CentOS7.6_docker.sh                                                                          #
...
##################################################################################################################
# Usage: ./CentOS7.6_docker.sh. This shell script will automatically run a bunch of testcases located within the #
