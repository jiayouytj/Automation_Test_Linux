...
##################################################################################################################
#title           :aa_install_ssl_bad_cert5.sh                                                                    #
...
#                 if UseSSL=yes, but Certificate is commented out.                                               #
#author		     :Zihao Yan                                                                                       #
#date            :20190306                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./aa_install_ssl_bad_cert5.sh                                                                  #
#actual results  :Testcase aa_install_ssl_bad_cert5.sh passed!                                                   #
#expected results:Testcase aa_install_ssl_bad_cert5.sh passed!                                                   #
##################################################################################################################
...
sed -i 's/^Certificate/#&/g' $conf_path                                                                          #comment out Certificate
