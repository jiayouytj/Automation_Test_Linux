...
##################################################################################################################
#title           :aa_install_ssl_bad_key2.sh                                                                     #
...
#                 if UseSSL=yes, but PrivateKey does not exist.                                                  #
#author		     :Zihao Yan                                                                                       #
#date            :20190306                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./aa_install_ssl_bad_key2.sh                                                                   #
#actual results  :Testcase aa_install_ssl_bad_key2.sh passed!                                                    #
#expected results:Testcase aa_install_ssl_bad_key2.sh passed!                                                    #
##################################################################################################################
...
msg_error="The certificate key file $PrivateKey does not exist. The installation aborted"                        #message for a sign of bad PrivateKey
rm -rf $log $log_fail $PrivateKey                                                                                #remove logs and PrivateKey for conflict
