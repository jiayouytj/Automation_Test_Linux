...
##################################################################################################################
#title           :aa_install_ssl_bad_key3.sh                                                                     #
...
#                 if UseSSL=yes, but PrivateKey is invalid.                                                      #
#author		     :Zihao Yan                                                                                       #
#date            :20190306                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./aa_install_ssl_bad_key3.sh                                                                   #
#actual results  :Testcase aa_install_ssl_bad_key3.sh passed!                                                    #
#expected results:Testcase aa_install_ssl_bad_key3.sh passed!                                                    #
##################################################################################################################
...
rm -rf $KEY                                                                                                      #remove PrivateKey for conflict
echo -e "garbage" >$KEY                                                                                          #create an invalid certificate key file
...
msg_error="The certificate key file $KEY is invalid. The installation aborted"                                   #message for a sign of bad CertFile
