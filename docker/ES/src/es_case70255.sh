...
#                 SingleNode=yes, and only one IP exists in ClusterMembers, which means that install.sh is       #
#                 correctly invoked and executed                                                                 #
#author		     :Zihao Yan                                                                                       #
#date            :20190206                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./es_case70255.sh                                                                              #
#actual results  :Testcase es_case70255.sh passed!                                                               #
#expected results:Testcase es_case70255.sh passed!                                                               #
##################################################################################################################
...
sed -i "s/$ClusterMembers/$IP/g" $conf_path                                                                      #modify the Elasticsearch conf file, change the ClusterMembers to the docker IP
