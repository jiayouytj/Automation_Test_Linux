...
#                 java-1.6.0-openjdk has been installed.which means that install.sh is correctly                 #
#                 invoked and executed                                                                           #
#author		     :Zihao Yan                                                                                       #
#date            :20190206                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./es_case72400_1.sh                                                                            #
#actual results  :Testcase es_case72400_1.sh passed!                                                             #
#expected results:Testcase es_case72400_1.sh passed!                                                             #
##################################################################################################################
...
yum -y install java-1.6.0-openjdk >>$log 2>&1                                                                    #install java-1.6.0-openjdk
