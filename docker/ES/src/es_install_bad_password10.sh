...
##################################################################################################################
#title           :es_install_bad_password10.sh                                                                   #
...
#date            :20190305                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./es_install_bad_password10.sh                                                                 #
#actual results  :Testcase es_install_bad_password10.sh passed!                                                  #
#expected results:Testcase es_install_bad_password10.sh passed!                                                  #
##################################################################################################################
