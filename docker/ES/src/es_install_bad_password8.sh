...
##################################################################################################################
#title           :es_install_bad_password8.sh                                                                    #
...
#                 if Password is commented out.                                                                  #
#author		     :Zihao Yan                                                                                       #
#date            :20190312                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./es_install_bad_password8.sh                                                                  #
#actual results  :Testcase es_install_bad_password8.sh passed!                                                   #
#expected results:Testcase es_install_bad_password8.sh passed!                                                   #
##################################################################################################################

conf_path=`ls config/setup.conf`                                                                                 #the Elasticsearch config file name
sed -i 's/^Password/#&/g' $conf_path                                                                             #comment out Password
...
msg_error="The Password should not be empty. The installation aborted"                                           #message for a sign of bad Password which is commented out
