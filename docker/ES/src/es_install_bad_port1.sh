...
#                 if the Port is less than 0.                                                                    #
#author		     :Zihao Yan                                                                                       #
#date            :20190404                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./es_install_bad_port1.sh                                                                      #
#actual results  :Testcase es_install_bad_port1.sh passed!                                                       #
#expected results:Testcase es_install_bad_port1.sh passed!                                                       #
##################################################################################################################
...
New_Port="-1"                                                                                                    #the new Port which is less than 0
