...
#                 /sys/class/dmi/id/product_uuid has permission 400,                                             #
#                 which means that install.sh is correctly invoked and executed.                                 #
#author          :Zihao Yan                                                                                       #
#date            :20190329                                                                                       #
#version         :1.0                                                                                            #
#usage           :./la_case77945.sh                                                                              #
#actual results  :Testcase la_case77945.sh passed!                                                               #
#expected results:Testcase la_case77945.sh passed!                                                               #
##################################################################################################################

chmod 400 /sys/class/dmi/id/product_uuid                                                                         #access read only permission on product_uuid
