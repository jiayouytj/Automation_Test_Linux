...
##################################################################################################################
#title           :la_install_bad_bindip1.sh                                                                      #
...
#                 if the BindIp is 888.888.888.888.                                                              #
#author		     :Zihao Yan                                                                                       #
#date            :20190329                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./la_install_bad_bindip1.sh                                                                    #
#actual results  :Testcase la_install_bad_bindip1.sh passed!                                                     #
#expected results:Testcase la_install_bad_bindip1.sh passed!                                                     #
##################################################################################################################
...
New_BindIp="888.888.888.888"                                                                                     #the new BindIp which is 888.888.888.888
