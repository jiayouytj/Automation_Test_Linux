...
##################################################################################################################
#title           :mq_install_bad_clusterid1.sh                                                                   #
...
#                 if Mode is mirror, and ClusterId is empty.                                                     #
#author		     :Zihao Yan                                                                                       #
#date            :20190218                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./mq_install_bad_clusterid1.sh                                                                 #
#actual results  :Testcase mq_install_bad_clusterid1.sh passed!                                                  #
#expected results:Testcase mq_install_bad_clusterid1.sh passed!                                                  #
##################################################################################################################
...
New_ClusterId=""                                                                                                 #the new ClusterId which is empty
