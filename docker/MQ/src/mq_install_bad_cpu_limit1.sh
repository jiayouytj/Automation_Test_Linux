...
##################################################################################################################
#title           :mq_install_bad_cpu_limit1.sh                                                                   #
...
#date            :20190225                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./mq_install_bad_cpu_limit1.sh                                                                 #
#actual results  :Testcase mq_install_bad_cpu_limit1.sh passed!                                                  #
#expected results:Testcase mq_install_bad_cpu_limit1.sh passed!                                                  #
##################################################################################################################
