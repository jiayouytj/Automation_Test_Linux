...
##################################################################################################################
#title           :re_install_bad_cpu_limit2.sh                                                                   #
...
#                 if CPULimit is a valid number without % appended.                                              #
#author		     :Zihao Yan                                                                                       #
#date            :20190303                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./re_install_bad_cpu_limit2.sh                                                                 #
#actual results  :Testcase re_install_bad_cpu_limit2.sh passed!                                                  #
#expected results:Testcase re_install_bad_cpu_limit2.sh passed!                                                  #
##################################################################################################################
...
New_CPULimit="90"                                                                                                #the new CPULimit which is not mirror or standalone
