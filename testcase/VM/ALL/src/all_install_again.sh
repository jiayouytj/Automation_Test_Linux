...
###########################################################################################################################
#title           :all_install_again.sh                                                                                    #
#description     :The purpose of this testcase is to test that netbrain-all-in-two-linux                                  #
#                 can NOT be successfully installed in docker if all                                                      #
#                 the netbrain-all-in-two-linux components have been already installed.                                   #
#author          :Zihao Yan                                                                                                #
#date            :20190501                                                                                                #
#version         :1.0                                                                                                     #
#usage           :./all_install_again.sh                                                                                  #
#actual results  :Testcase all_install_again.sh passed!                                                                   #
#expected results:Testcase all_install_again.sh passed!                                                                   #
###########################################################################################################################
...
log2="ALL_installed.log"                                                                                                  #installation log if installing netbrain-all-in-two-linux again
...
msg_again="All the NetBrain Linux components have been installed. The installation aborted"                               #message for a sign of netbrain-all-in-two-linux already installed
...
input2="input2.file"                                                                                                      #input file for install.sh
Password="admin"                                                                                                          #NetBrain service password
rm -rf $input2                                                                                                            #remove input file for conflict
echo -e "YES" >$input2                                                                                                    #echo YES to agree the EULA
echo -e "I ACCEPT" >>$input2                                                                                              #echo I ACCEPT to accept the terms in the subscription EULA
timeout 600 ./install.sh <$input2 >$log2 2>&1                                                                             #execute netbrain-all-in-two-linux installation script again and save the log
if [ $? -eq 124 ];then                                                                                                    #determine if the testcase runs timed out
    echo "Testcase $BASH_SOURCE timeout!"
   ...
   if grep -q "$msg_again" $log2;then                                                                                     #determine if netbrain-all-in-two-linux installation is successfully completed
