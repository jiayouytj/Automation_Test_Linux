...
###########################################################################################################################
#title           :all_install_bad_input1.sh                                                                               #
...
#                 while typing none of the y|Y|yes|YES|n|N|no|NO for all yes/no validation, an error is given,            #
#                 which means that install.sh is correctly invoked and executed.                                          #
#author          :Zihao Yan                                                                                                #
#date            :20190501                                                                                                #
#version         :1.0                                                                                                     #
#usage           :./all_install_bad_input1.sh                                                                             #
#actual results  :Testcase all_install_bad_input1.sh passed!                                                              #
#expected results:Testcase all_install_bad_input1.sh passed!                                                              #
###########################################################################################################################
...
echo -e "nope" >>$input                                                                                                   #bad input for "no"
echo -e "none" >>$input                                                                                                   #bad input for "no"
echo -e "nah" >>$input                                                                                                    #bad input for "no"
echo -e "negative" >>$input                                                                                               #bad input for "no"
echo -e "NOPE" >>$input                                                                                                   #bad input for "no"
echo -e "NONE" >>$input                                                                                                   #bad input for "no"
echo -e "NAH" >>$input                                                                                                    #bad input for "no"
echo -e "NEGATIVE" >>$input                                                                                               #bad input for "no"
echo -e "yup" >>$input                                                                                                    #bad input for "yes"
echo -e "yep" >>$input                                                                                                    #bad input for "yes"
echo -e "yea" >>$input                                                                                                    #bad input for "yes"
echo -e "yeah" >>$input                                                                                                   #bad input for "yes"
echo -e "YUP" >>$input                                                                                                    #bad input for "yes"
echo -e "YEP" >>$input                                                                                                    #bad input for "yes"
echo -e "YEA" >>$input                                                                                                    #bad input for "yes"
echo -e "YEAH" >>$input                                                                                                   #bad input for "yes"
...
msg_error="The parameter is invalid, it can be only yes|y|no|n. The installation aborted"                                 #message for a sign of invalid parameters
...
timeout 1200 bash -c ". `pwd`/install.sh <$input" >$log 2>&1                                                              #execute netbrain-all-in-two-linux installation script and save the log
...
if ! [[ `grep "$msg_error" "$log"|wc -l` == 48 ]];then                                                                    #if the testcase fails, generate the reasons for the failure
echo -e "The number of bad parameter output are not 48. This may indicate \
...
&& [ -d "$MQ_LogPath" ] && [ -d "$RE_LogPath" ] && [ -d "$SM_LogPath" ] && [[ `grep "$msg_error" "$log"|wc -l` == 48 ]] \
