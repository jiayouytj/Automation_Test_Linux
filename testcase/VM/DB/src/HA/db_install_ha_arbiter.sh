...
##################################################################################################################
#title           :db_install_ha_arbiter.sh                                                                       #
...
#                 The installation is for MongoDB replica for arbiter,                                           #
#                 which means that install.sh is correctly invoked and executed.                                 #
#author          :Zihao Yan                                                                                       #
#date            :20190613                                                                                       #
#version         :1.0                                                                                            #
#usage           :./db_install_ha_arbiter.sh                                                                     #
#actual results  :Testcase db_install_ha_arbiter.sh passed!                                                      #
#expected results:Testcase db_install_ha_arbiter.sh passed!                                                      #
##################################################################################################################
