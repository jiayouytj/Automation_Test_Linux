...
##################################################################################################################
#title           :db_install_ha_ssl_fqdn_arbiter.sh                                                              #
...
#                 is enabled. The installation is for MongoDB replica for arbiter using FQDN,                    #
#                 which means that install.sh is correctly invoked and executed.                                 #
#author          :Zihao Yan                                                                                       #
#date            :20190613                                                                                       #
#version         :1.0                                                                                            #
#usage           :./db_install_ha_ssl_fqdn_arbiter.sh                                                            #
#actual results  :Testcase db_install_ha_ssl_fqdn_arbiter.sh passed!                                             #
#expected results:Testcase db_install_ha_ssl_fqdn_arbiter.sh passed!                                             #
##################################################################################################################
...
timeout 600 ./install_arbiter.sh >../$log 2>&1                                                                   #execute MongoDB installation script and save the log
