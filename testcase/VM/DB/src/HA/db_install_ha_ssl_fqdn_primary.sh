...
##################################################################################################################
#title           :db_install_ha_ssl_fqdn_primary.sh                                                              #
...
#                 is enabled. The installation is for MongoDB replica for primary using FQDN,                    #
#                 which means that install.sh is correctly invoked and executed.                                 #
#author          :Zihao Yan                                                                                       #
#date            :20190613                                                                                       #
#version         :1.0                                                                                            #
#usage           :./db_install_ha_ssl_fqdn_primary.sh                                                            #
#actual results  :Testcase db_install_ha_ssl_fqdn_primary.sh passed!                                             #
#expected results:Testcase db_install_ha_ssl_fqdn_primary.sh passed!                                             #
##################################################################################################################
