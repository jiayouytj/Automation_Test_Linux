...
#                 The installation is on master for RabbitMQ cluster.                                            #
#                 which means that install.sh is correctly invoked and executed                                  #
#author		     :Derek Li                                                                                       #
#date            :20190613                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./mq_install_ha_master.sh                                                                      #
#actual results  :Testcase mq_install_ha_master.sh passed!                                                       #
#expected results:Testcase mq_install_ha_master.sh passed!                                                       #
##################################################################################################################
