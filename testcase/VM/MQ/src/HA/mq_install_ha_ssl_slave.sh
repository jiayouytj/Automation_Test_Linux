...
##################################################################################################################
#title           :mq_install_ha_ssl_slave.sh                                                                     #
...
#                 enabled. The installation is on slave for RabbitMQ cluster.                                    #
#                 which means that install.sh is correctly invoked and executed                                  #
#author		     :Derek Li                                                                                       #
#date            :20190613                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./mq_install_ha_ssl_slave.sh                                                                   #
#actual results  :Testcase mq_install_ha_ssl_slave.sh passed!                                                    #
#expected results:Testcase mq_install_ha_ssl_slave.sh passed!                                                    #
##################################################################################################################
