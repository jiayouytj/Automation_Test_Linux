...
#                 The installation is on slave for Redis cluster.                                                #
#                 which means that install.sh is correctly invoked and executed.                                 #
#author		     :Zihao Yan                                                                                       #
#date            :20190613                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./re_install_ha_slave.sh                                                                       #
#actual results  :Testcase re_install_ha_slave.sh passed!                                                        #
#expected results:Testcase re_install_ha_slave.sh passed!                                                        #
##################################################################################################################
