...
##################################################################################################################
#title           :aa_install_ssl_bad_key4.sh                                                                     #
...
#                 if UseSSL=yes, but PrivateKey is missing.                                                      #
#author		     :Zihao Yan                                                                                       #
#date            :20190306                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./aa_install_ssl_bad_key4.sh                                                                   #
#actual results  :Testcase aa_install_ssl_bad_key4.sh passed!                                                    #
#expected results:Testcase aa_install_ssl_bad_key4.sh passed!                                                    #
##################################################################################################################
...
sed -i '/^PrivateKey/d' $conf_path                                                                               #delete the line containing PrivateKey
