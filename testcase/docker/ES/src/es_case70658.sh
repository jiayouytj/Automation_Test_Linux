...
#                 puppet has been installed, which means that install.sh is correctly invoked and executed       #
#author		     :Zihao Yan                                                                                       #
#date            :20190206                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./es_case70658.sh                                                                              #
#actual results  :Testcase es_case70658.sh passed!                                                               #
#expected results:Testcase es_case70658.sh passed!                                                               #
##################################################################################################################

yum -y install puppet-server >/dev/null 2>&1                                                                     #install puppet server and client
puppetmaster="puppetmaster"                                                                                      #Puppet server service name
puppet="puppet"                                                                                                  #Puppet client service name
