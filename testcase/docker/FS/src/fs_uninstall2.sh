...
#date            :20190409                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./fs_uninstall2.sh                                                                             #
#actual results  :Testcase fs_uninstall2.sh passed!                                                              #
#expected results:Testcase fs_uninstall2.sh passed!                                                              #
##################################################################################################################
...
timeout 600 echo "yes"|./others/uninstall.sh >$log2 2>&1                                                         #execute Front Server uninstallation script and save the log    
if [ $? -eq 124 ];then                                                                                           #determine if the testcase runs timed out
    echo "Testcase $BASH_SOURCE timeout!"
