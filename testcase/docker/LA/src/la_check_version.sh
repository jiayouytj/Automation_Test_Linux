...
#date            :20190404                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./la_check_version.sh                                                                          #
#actual results  :Testcase la_check_version.sh passed!                                                           #
#expected results:Testcase la_check_version.sh passed!                                                           #
##################################################################################################################
...
&& ! file $upgrade|grep -q "$Windows";then                                                                       #determine if License Agent version checking is successfully completed#determine if MongoDB version checking is successfully completed
