...
##################################################################################################################
#title           :mq_install_bad_clusterid2.sh                                                                   #
...
#                 if Mode is mirror, and ClusterId is a space.                                                   #
#author		     :Zihao Yan                                                                                       #
#date            :20190218                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./mq_install_bad_clusterid2.sh                                                                 #
#actual results  :Testcase mq_install_bad_clusterid2.sh passed!                                                  #
#expected results:Testcase mq_install_bad_clusterid2.sh passed!                                                  #
##################################################################################################################
...
ClusterId="`grep "^ClusterId" $conf_path|tr "=" " "|awk '{print $2}'`"                                           #the default ClusterId
ClusterId_line_number=`grep -n "^ClusterId" $conf_path|cut -f 1 -d":"`                                           #get ClusterId config line number
New_ClusterId=" "                                                                                                #the new ClusterId which is a space
sed -i "${ClusterId_line_number}s/$ClusterId/$New_ClusterId/" $conf_path                                         #modify the RabbitMQ conf file, change default Mode
