...
##################################################################################################################
#title           :mq_install_bad_cpu_limit3.sh                                                                   #
...
#date            :20190225                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./mq_install_bad_cpu_limit3.sh                                                                 #
#actual results  :Testcase mq_install_bad_cpu_limit3.sh passed!                                                  #
#expected results:Testcase mq_install_bad_cpu_limit3.sh passed!                                                  #
##################################################################################################################
...
New_CPULimit="0%"                                                                                                #the new CPULimit which is 0%
