...
##################################################################################################################
#title           :sm_install_bad_ca_verify6.sh                                                                   #
...
#date            :20190319                                                                                       #
#version         :1.0                                                                                            #
#usage		     :./sm_install_bad_ca_verify6.sh                                                                 #
#actual results  :Testcase sm_install_bad_ca_verify6.sh passed!                                                  #
#expected results:Testcase sm_install_bad_ca_verify6.sh passed!                                                  #
##################################################################################################################
...
New_CA_Verify="abcdefghijklmnopqrstuvwxyz"                                                                       #the new CA_Verify which is not yes or no
